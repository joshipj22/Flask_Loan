...
def home():
    return "<h1>Welcome to the Loan API!</h1>"
...
def make_predict():
    ...
    #The sequence of input feature should follow the same cronology of i/p features,
    ######on which the model was orignally trained
